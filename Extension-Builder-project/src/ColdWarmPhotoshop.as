package 
{
	...
	public class ColdWarmPhotoshop extends Sprite
	{
		...
		{
			//trace("3: " + "Stage.stageWidth: " + _displayParent.stage.stageWidth)
			//trace("3: " + "Stage.width: " + _displayParent.stage.width)
			
			_windowWidth = stage.stageWidth;
			_windowHeight = stage.stageHeight;// - 24;
			calculateScale();
		}
		
		private function calculateScale():void
		{
			/*var plateWidth:int = (_windowWidth - Settings.plateBorderIndent * 2 - Settings.saturationRawDistance) / Settings.plateRawQuantity + 1;
			var windowWidthWithoutSaturation:int = _windowWidth - Settings.saturationRawDistance - plateWidth;
